...
By the way, the lyrics data I translated is from the [UTAU song database](https://w.atwiki.jp/utauuuta/pages/4322.html). They use the lyrics that are typed out in the video. There are slight differences between the video's text and the words that are actually sung.
